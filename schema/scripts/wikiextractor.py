...
'''
Reform XML wiki dump file to json
...
def main():
    ...
    parser.add_argument('-i', dest='input', type=str, default=None, required=True, help='XML wiki dump file')

    groupO = parser.add_argument_group('Output')
    groupO.add_argument('-o', dest='output', type=str, default=None, required=True, help='directory for extracted files (or - for dumping to stdout)')
    groupO.add_argument('-b', dest='bytes', type=str, default='1M', help='maximum bytes per output file (default %(default)s)', metavar='n[KMG]')
    groupO.add_argument('-c', dest='compress', action='store_true', help='compress output files using bzip')
    groupO.add_argument('-j', dest='json', action='store_true', help='write output in json format instead of the default <doc> format')

    groupP = parser.add_argument_group('Processing')
    groupP.add_argument('-ht', dest='html', action='store_true', help='produce HTML output, subsumes --links')
    groupP.add_argument('-l', dest='links', action='store_true', help='preserve links')
    groupP.add_argument('-ns', dest='namespaces', type=str, default='', help='accepted namespaces', metavar='ns1,ns2')
    
    groupP.add_argument('-t', dest='templates', type=str, default=None, help='use or create file containing templates')
    groupP.add_argument('-nt', dest='no_templates', action='store_false', help='Do not expand templates')
    groupP.add_argument('-hs', dest='html_safe', type=bool, default=True, help='use to produce HTML safe output within <doc>...</doc>')

    default_process_count = cpu_count() - 1
    parser.add_argument('-p', dest='processes', type=int, default=default_process_count, help='Number of processes to use (default %(default)s)')

    groupS = parser.add_argument_group('Special')
    groupS.add_argument('-q', dest='quiet', action='store_true', help='suppress reporting progress info')
    groupS.add_argument('-d', dest='debug', action='store_true', help='print debug info')
    groupS.add_argument('-a', dest='article', action='store_true', help='analyze a file containing a single article (debug option)')
    groupS.add_argument('-v', dest='version', action='version', version='%(prog)s ' + __version__, help='print program version')
